...
#define GST_CUDA_ALLOCATOR_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_CAST(           \
        (klass), GST_TYPE_CUDA_ALLOCATOR, GstCudaAllocatorClass))
#define GST_CUDA_ALLOCATOR_GET_CLASS(obj) \
    (G_TYPE_INSTANCE_GET_CLASS(           \
        (obj), GST_TYPE_CUDA_ALLOCATOR, GstCudaAllocatorClass))
...
gst_cuda_allocator_get_type(void);

extern __attribute__((visibility("default"))) GstAllocator *
gst_cuda_allocator_new(GstCudaContext *context);

extern __attribute__((visibility("default"))) GstMemory *
