...
GST_DEBUG_CATEGORY_STATIC(gst_nvrtcloader_debug);
...
static GstNvCodecNvrtcVtahle gst_nvrtc_vtable = {
    0,
};
...
gboolean gst_nvrtc_load_library(void)
{
    ...
    GST_DEBUG_CATEGORY_INIT(
        gst_nvrtcloader_debug,
        "cudanvrtcloader",
        0,
        "CUDA NVRTC Dynamic Library Loader");
     ...
     * same as CUDA library */
        {
                ...
                minor_version--)
            {
                ...
                filename = g_strdup_printf(
                    NVRTC_LIBNAME, cuda_major_version, minor_version);
                fname = filename;
    ...
    const char **includeNames)
{
    ...
    return gst_nvrtc_vtable.NvrtcCreateProgram(
