...
#define GST_CUDA_BASE_FILTER(obj) \
    (G_TYPE_CHECK_INSTANCE_CAST(  \
        (obj), GST_TYPE_CUDA_BASE_FILTER, GstCudaBaseFilter))
#define GST_CUDA_BASE_FILTER_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_CAST(             \
        (klass), GST_TYPE_CUDA_BASE_FILTER, GstCudaBaseFilterClass))
#define GST_CUDA_BASE_FILTER_GET_CLASS(obj) \
    (G_TYPE_INSTANCE_GET_CLASS(             \
        (obj), GST_TYPE_CUDA_BASE_FILTER, GstCudaBaseFilterClass))
#define GST_IS_CUDA_BASE_FILTER(obj) \
    (G_TYPE_CHECK_INSTANCE_TYPE((obj), GST_TYPE_CUDA_BASE_FILTER))
#define GST_IS_CUDA_BASE_FILTER_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_TYPE((klass), GST_TYPE_CUDA_BASE_FILTER))
...
gst_cuda_base_filter_get_type(void);
