...
#define GST_CUDA_BUFFER_POOL(obj) \
    (G_TYPE_CHECK_INSTANCE_CAST(  \
        (obj), GST_TYPE_CUDA_BUFFER_POOL, GstCudaBufferPool))
#define GST_CUDA_BUFFER_POOL_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_CAST(             \
        (klass), GST_TYPE_CUDA_BUFFER_POOL, GstCudaBufferPoolClass))
#define GST_CUDA_BUFFER_POOL_GET_CLASS(obj) \
    (G_TYPE_INSTANCE_GET_CLASS(             \
        (obj), GST_TYPE_CUDA_BUFFER_POOL, GstCudaBufferPoolClass))
#define GST_IS_CUDA_BUFFER_POOL(obj) \
    (G_TYPE_CHECK_INSTANCE_TYPE((obj), GST_TYPE_CUDA_BUFFER_POOL))
#define GST_IS_CUDA_BUFFER_POOL_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_TYPE((klass), GST_TYPE_CUDA_BUFFER_POOL))
...
gst_cuda_buffer_pool_get_type(void);

extern __attribute__((visibility("default"))) GstBufferPool *
